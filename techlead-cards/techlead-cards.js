...
var author$project$NotesBehindClosedDoors$note_01 = A4(author$project$Note$Note, 'Most general definition', '\nGreat management is about **leading and developing people** and **managing tasks**.\n\nYou need to learn three things when you enter a new organization or job:\n\n* Who the people are - their strengths and interests - and what they are working on\n* The stated mission of the group and how the group provides value\n* How your group fits into the larger organization\n\n', 'Behind Closed Doors', 'https://www.goodreads.com/book/show/4100.Behind_Closed_Doors');
var author$project$NotesBehindClosedDoors$note_02 = A4(author$project$Note$Note, 'One-on-ones', '\nProperly done, one-on-ones build relationships. Used consistently are found to be one of the most effective and productive use of manager’s time. One-on-ones provide a venue for coaching, feedback, career development, and status reporting.\n\n### Rules:\n\n* establish a standard weekly time\n* remember your manners\n* hold one-on-ones faithfully\n* follow a consistent format for your one-on-ones\n* be adaptable\n\n### Managing people:\n\n* You can’t spend too much time with people.\n* Don’t offer help if you can’t deliver.\n* Management by Walking Around and Listening.\n* Respect people’s space and time.\n* Take notes.\n* Multitasking: Wasting mental cycles.\n', 'Behind Closed Doors', 'https://www.goodreads.com/book/show/4100.Behind_Closed_Doors');
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		var index = A2(
			...
			elm$core$List$length(author$project$Main$notes),
			(elm$time$Time$posixToMillis(time) / (86400 * 1000)) | 0);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					currentNote: function (l) {
						if (l.b) {
							var h = l.a;
							var t = l.b;
						...
						A2(elm$core$List$drop, index, author$project$Main$notes)),
					id: elm$core$Maybe$Just(index),
...
var author$project$Main$appDescription = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Main$displayNote = F2(
	function (model, note) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2(elm_explorations$markdown$Markdown$toHtml, _List_Nil, note.content)
						])),
					A2(
					elm$html$Html$a,
					_List_fromArray(
						[
							elm$html$Html$Attributes$href(note.citationUrl)
						]),
					_List_fromArray(
						[
							elm$html$Html$text(note.citationName)
						]))
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				if (_n0.$ === 'Just') {
					var note = _n0.a;
					return A2(author$project$Main$displayNote, model, note);
				} else {
...
var author$project$Main$showTime = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('float-right footer')
					]),
				_List_fromArray(
					[
						function () {
		...
		_List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[author$project$Main$title, author$project$Main$appDescription, author$project$Main$card, author$project$Main$showTime])))
			]));
};
